...
const MenuButton = React.createClass({
    ...
    render () {
        ...
        const {buttonStyle,menuGroup,optionsStyle,button,optionStyle,selectedOptionStyle,optionTextStyle,optionImageStyle,selectedOptionTextStyle} = this.props
                                            ...
                                            if (!menu.hide) {
                                                ...
                                                return (
                                                    <MenuOption key={menu.key} onPress={this.onPress.bind(null,menu.value)}  style={[optionStyle,selectStyle]}>
                                                        <Image style={[{width: 0, height:0}, optionImageStyle]} source={menu.image} /> 
